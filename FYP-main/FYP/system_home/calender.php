...
<body>
    ...
    <div class="side-bar">
        ...
        <ul class="menu-list">
            ...
            <li><a href="calender.php" class="active"><i class='bx bxs-chat'></i>Calender</a></li>
    ...
    // $date_sql = "SELECT * FROM event_db";
    // $check_date_sql = mysqli_query($dbconnection , $date_sql);
    // $date = mysqli_fetch_assoc($check_date_sql);
    
    
    ?>

    <!-- <script>
        let date = "<?php echo $date['event_date']; ?>";
        console.log(date);
        ...
        while($event_data_result = mysqli_fetch_assoc($check_event)){
            ...
            <div class='event_details'>
                <div class='event_card'>
                    <i class='bx bx-dots-vertical-rounded menu-dot' onclick='dropDown()'></i>
                    <div class='drop-down'>
                    <a href='#'>
